...
export type ContextFactKind = 'project_profile' | 'architecture_decision' | 'module_boundary' | 'user_preference' | 'current_goal' | 'runtime_error_chain' | 'code_entrypoint' | 'known_issue' | 'project_convention' | 'workflow_rule'
export const AUTO_ACCEPT_CONTEXT_FACT_KINDS = ['project_profile', 'architecture_decision', 'module_boundary', 'project_convention', 'workflow_rule', 'code_entrypoint', 'runtime_error_chain'] as const satisfies readonly ContextFactKind[]
